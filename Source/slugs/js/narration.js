...
class Narration {
    ...
    intro_1() {
        ...
        logOutput(`when you type something that the game does not understand, the box will shake a little, but don't worry, that's just to help you notice! it might also shake if a message is repeated, or there is another reason why you should look at this part of the game.`)
    ...
    intro_2() {
        ...
        logOutput(`congratulations! you now know how to play the game. have fun! if you don't know what to do, are confused, or need inspiration, try using the ${wrapCmd('help')} command!`)
