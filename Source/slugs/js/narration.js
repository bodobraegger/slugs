...
class Narration {
    intro() {
        startNewLogSegment()
        logOutput(`dear player, welcome to this little game. on the left side of the screen you see a little being, in its little sea around it. its ${wrapCmd('color')} is ${wrapCmd(COLORCATS_HR[getColorCategory(playersBeing.color)])}.`)
        ...
        logOutput(`to communicate with the being, you will need to write what you want to do in the box below. 
    ...
    hunted() {
        startNewLogSegment()
        logError(`uh oh, a larger creature is angry and hungry and wants to <u class='playerscolor'>eat your being, it is projecting a line to it!</u>`)
        ...
        logOutput(`you must quickly tell your being to ${wrapCmd('flee')}!`)
}
}