...
function narration_intro() {
    logOutput(`dear player, welcome to this little game. on the left side of the screen you see a little being, in its little sea around it. its color is ${COLORCATS_HR[getColorClass(playersBeing.color)]}.`)
    ...
    logOutput(`to communicate with the being and figure out more ways to play the game, you will need to write what you want to do in the box below. if you ever want to see this introduction again, type ${wrapCmd('intro')} below. try typing  ${wrapCmd('hello')} or  ${wrapCmd('help')} to learn more!`)
}
